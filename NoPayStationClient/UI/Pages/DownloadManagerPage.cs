...
public class DownloadManagerPage : BasePage
{
    ...
    public override IRenderable Render()
    {
        ...
        if (activeDownloads.Count > 0)
        {
            ...
            activeTable.AddColumn(new TableColumn("[yellow]Progress[/]").Width(30));
            activeTable.AddColumn(new TableColumn("[yellow]Speed[/]").Width(12));
            activeTable.AddColumn(new TableColumn("[blue]ETA[/]").Width(12));
            ...
            for (int i = 0; i < activeDownloads.Count; i++)
            {
                ...
                activeTable.AddRow(
                    ...
                    download.EstimatedTimeRemaining?.ToString(@"hh\:mm\:ss") ?? "[grey]N/A[/]",

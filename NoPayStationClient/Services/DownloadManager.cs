...
namespace NoPayStationClient.Services
{
    public class DownloadManager
    {
        ...
        private async Task<DownloadTask> DownloadRapAsync(string rapHex, string outputPath, string titleId, DownloadTask task)
        {
            try
            {
                task.Status = DownloadStatus.Downloading;
                var path = await _downloadService.DownloadRapFromHexAsync(rapHex, outputPath, titleId);
